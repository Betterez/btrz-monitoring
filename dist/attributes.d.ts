...
export declare const monitoringAttributes: {
    ...
    readonly ATTR_CONTAINER_ID: "container.id";
    readonly ATTR_CONTAINER_IMAGE_NAME: "container.image.name";
    readonly ATTR_CONTAINER_IMAGE_REPO_DIGESTS: "container.image.repo_digests";
    readonly ATTR_CONTAINER_IMAGE_TAGS: "container.image.tags";
    ...
    readonly ATTR_K8S_CLUSTER_NAME: "k8s.cluster.name";
    readonly ATTR_K8S_CLUSTER_UID: "k8s.cluster.uid";
    readonly ATTR_K8S_CONTAINER_NAME: "k8s.container.name";
    readonly ATTR_K8S_CONTAINER_RESTART_COUNT: "k8s.container.restart_count";
    readonly ATTR_K8S_CRONJOB_ANNOTATION: (key: string) => string;
    readonly ATTR_K8S_CRONJOB_LABEL: (key: string) => string;
    readonly ATTR_K8S_CRONJOB_NAME: "k8s.cronjob.name";
    readonly ATTR_K8S_CRONJOB_UID: "k8s.cronjob.uid";
    readonly ATTR_K8S_DAEMONSET_ANNOTATION: (key: string) => string;
    readonly ATTR_K8S_DAEMONSET_LABEL: (key: string) => string;
    readonly ATTR_K8S_DAEMONSET_NAME: "k8s.daemonset.name";
    readonly ATTR_K8S_DAEMONSET_UID: "k8s.daemonset.uid";
    readonly ATTR_K8S_DEPLOYMENT_ANNOTATION: (key: string) => string;
    readonly ATTR_K8S_DEPLOYMENT_LABEL: (key: string) => string;
    readonly ATTR_K8S_DEPLOYMENT_NAME: "k8s.deployment.name";
    readonly ATTR_K8S_DEPLOYMENT_UID: "k8s.deployment.uid";
    readonly ATTR_K8S_JOB_ANNOTATION: (key: string) => string;
    readonly ATTR_K8S_JOB_LABEL: (key: string) => string;
    readonly ATTR_K8S_JOB_NAME: "k8s.job.name";
    readonly ATTR_K8S_JOB_UID: "k8s.job.uid";
    readonly ATTR_K8S_NAMESPACE_ANNOTATION: (key: string) => string;
    readonly ATTR_K8S_NAMESPACE_LABEL: (key: string) => string;
    readonly ATTR_K8S_NAMESPACE_NAME: "k8s.namespace.name";
    readonly ATTR_K8S_NODE_ANNOTATION: (key: string) => string;
    readonly ATTR_K8S_NODE_LABEL: (key: string) => string;
    readonly ATTR_K8S_NODE_NAME: "k8s.node.name";
    readonly ATTR_K8S_NODE_UID: "k8s.node.uid";
    readonly ATTR_K8S_POD_ANNOTATION: (key: string) => string;
    readonly ATTR_K8S_POD_HOSTNAME: "k8s.pod.hostname";
    readonly ATTR_K8S_POD_IP: "k8s.pod.ip";
    readonly ATTR_K8S_POD_LABEL: (key: string) => string;
    readonly ATTR_K8S_POD_NAME: "k8s.pod.name";
    readonly ATTR_K8S_POD_START_TIME: "k8s.pod.start_time";
    readonly ATTR_K8S_POD_UID: "k8s.pod.uid";
    readonly ATTR_K8S_REPLICASET_ANNOTATION: (key: string) => string;
    readonly ATTR_K8S_REPLICASET_LABEL: (key: string) => string;
    readonly ATTR_K8S_REPLICASET_NAME: "k8s.replicaset.name";
    readonly ATTR_K8S_REPLICASET_UID: "k8s.replicaset.uid";
    readonly ATTR_K8S_STATEFULSET_ANNOTATION: (key: string) => string;
    readonly ATTR_K8S_STATEFULSET_LABEL: (key: string) => string;
    readonly ATTR_K8S_STATEFULSET_NAME: "k8s.statefulset.name";
    readonly ATTR_K8S_STATEFULSET_UID: "k8s.statefulset.uid";
    ...
    readonly TELEMETRY_SDK_LANGUAGE_VALUE_KOTLIN: "kotlin";
